 ...
 * Window - Preferences - Java - Code Generation - Code and Comments
 */
public class PageProprietesListePersonnesIHM extends PageAssistantIHM {
	
	private ResourceBundle message = ResourceBundle.getBundle(Config.config.getProperty("cheminTraduction") + "." + Config.locale.getLanguage() + getClass().getName().substring(getClass().getName().lastIndexOf('.')), Config.locale);
	
	public PageProprietesListePersonnesIHM(final Shell shell) {
		...
		titre.setFont(font);
		titre.setText(message.getString("PageProprietesIHM.titreProprietesListePersonnes"));
