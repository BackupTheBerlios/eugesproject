...
public class PageProprietesActRealiseIHM extends PageAssistantIHM {
	...
	public PageProprietesActRealiseIHM(final Shell shell, EugesActRealise actRea) {
		...
		titre.setFont(font);
		titre.setText(message.getString("PageProprietesIHM.actRealise.titre"));
		...
		lblActivite.setText(message.getString("PageProprietesIHM.iteration.lblActivite"));
		...
		lblNumIteration.setText(message.getString("PageProprietesIHM.iteration.lblNumIteration"));
